		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "MAN MOVEMENT",
									"targetURL": "#bsimhcmappmanmovement-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"bsimhcmappmanmovement-display": {
								"semanticObject": "bsimhcmappmanmovement",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=bsim.hcmapp.man.movement",
									"url": sap.ui.require.toUrl("bsim/hcmapp/man/movement")
								}
							}
						}
					}
