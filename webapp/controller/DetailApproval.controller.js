sap.ui.define([
    ...
    return Controller.extend("bsim.hcmapp.man.movement.controller.DetailApproval", {
        formatter: f,
        ...
        onInit: function () {
            ...
            // this.getRouter().getRoute("EmployeeApproval").attachPatternMatched(this._onRouteMatched, this);
