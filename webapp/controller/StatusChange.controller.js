sap.ui.define([
    ...
    return BaseController.extend("bsim.hcmapp.man.movement.controller.StatusChange", {
        ...
        _postRequest: function() {
            ...
            const checkboxIds = ["hasilStatus1", "hasilStatus2", "hasilStatus3", "hasilStatus4", "hasilStatus5"];
            ...
            let oPayload = {
                ...
                Status: "S",  
                Massg: this.byId("reasonStatus").getValue(),
                ZbegdaEfktf: getFormattedDate("effectiveDateStartStatus"),
                ZenddaEfktf: getFormattedDate("effectiveDateEndStatus"),
                PlansDest: this.byId("newPositionStatus").getValue(),
                WerksDest: this.byId("newPerAreaStatus").getValue(),
                BtrtlDest: this.byId("newPerSubAreaStatus").getValue(),
                PersgDest: this.byId("newStatusStatus").getValue(),
                PerskDest: this.byId("newJobTitleStatus").getValue(),
                HbsDest: this.byId("newHomeBaseStatus").getValue(),
                Adjstmn: this.getView().getModel("dropdown").getProperty("/selectedSalaryAdj") || "",
                Zsalary: this.byId("salaryAdjValueStatus").getValue(),
                Zdasar1: this.getView().getModel("dropdown").getProperty("/selectedAs") || "",
                Zdasar2: this.byId("basicConStatus").getValue(),
                Zassessment: (parseInt(this.getView().getModel("assessmentStatus").getProperty("/selectedIndex")) + 1).toString(),
                Zbichecking: Zbichecking, //checkbox bi checking
                Znotebicheck: this.byId("hasilBiCheckingStatus").getValue(),
                Zdisposisi: (parseInt(this.getView().getModel("disposisiStatus").getProperty("/selectedIndex")) + 1).toString(), 
                Zsalaryfnl: this.byId("gajiStatus").getValue()
            };
            ...
            let oModel = this.getOwnerComponent().getModel("StatusChange");
