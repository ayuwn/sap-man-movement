sap.ui.define([
    ...
    return BaseController.extend("bsim.hcmapp.man.movement.controller.Assignment", {
        ...
        _postRequest: function() {
            ...
            const checkboxIds = ["hasilAssignment1", "hasilAssignment2", "hasilAssignment3", "hasilAssignment4", "hasilAssignment5"];
            ...
            let oPayload = {
                ...
                PlansDest: this.byId("newPositionAssignment").getValue(),
                WerksDest: this.byId("newPerAreaAssignment").getValue(),
                BtrtlDest: this.byId("newPerSubAreaAssignment").getValue(),
                PersgDest: this.byId("newStatusAssignment").getValue(),
                PerskDest: this.byId("newJobTitleAssignment").getValue(),
                HbsDest: this.byId("newHomeBaseAssignment").getValue(),
                Adjstmn: this.getView().getModel("dropdown").getProperty("/selectedSalaryAdj") || "",
                Zsalary: this.byId("salaryAdjValueAssignment").getValue(),
                Zdasar1: this.getView().getModel("dropdown").getProperty("/selectedAs") || "",
                Zdasar2: this.byId("basicConAssignment").getValue(),
                Zassessment: (parseInt(this.getView().getModel("assessmentAssignment").getProperty("/selectedIndex")) + 1).toString(),
                Zbichecking: Zbichecking, //checkbox bi checking
                Znotebicheck: this.byId("hasilBiCheckingAssignment").getValue(),
                Zdisposisi: (parseInt(this.getView().getModel("disposisiAssignment").getProperty("/selectedIndex")) + 1).toString(), 
                Zsalaryfnl: this.byId("gajiAssignment").getValue()
            };
            ...
            let oModel = this.getOwnerComponent().getModel("Assignment");
