sap.ui.define([
    ...
    return BaseController.extend("bsim.hcmapp.man.movement.controller.Demotion", {
        formatter: formatter,
        ...
        onInit: function () {
            ...
            // this._currentUser();
            this._currentUserPromise = new Promise((resolve, reject) => {
                this._currentUser(resolve, reject);
            });
            ...
            this.getView().byId("effectiveDateEndDemotion").setValue(sFormattedEndDate);
            this.getView().byId("effectiveDateStartDemotion").setValue(sFormattedDate);
        ...
        _getEmployeeData: function (EmployeeNumber) {
            ...
            // Get the Demotion OData model
            const oDemotionModel = this.getOwnerComponent().getModel("Demotion");
        
            if (!oDemotionModel) {
                console.error("Demotion model is not available.");
                MessageBox.error("System error: Demotion model is not available.");
                return;
            }
            ...
            this.readEntityFromModel(oDemotionModel, sEmployeePath)
                .then((employeeResult) => {
                    if (!employeeResult) {
                    ...
                    return this.readEntityFromModel(oDemotionModel, sEmployeeDetailPath);
                })
        ...
        _currentUser: function (resolve, reject) {
            this._oBusy.open();
            var oDataModel = this.getOwnerComponent().getModel("Demotion");
            if (!oDataModel) {
                this._oBusy.close();
        ...
        _currentUser: function () {
            ...
            var oDataModel = this.getOwnerComponent().getModel("Demotion"); // Get the default OData model
        ...
        onSalaryAdjChange: function (oEvent) {
            ...
            if (sSelectedKey === "1") { // "Ya"
                ...
                this.byId("salaryAdjValueDemotion").setValue(""); // Clear the input value
            }
        },
        ...
        //             MessageBox.error("Required data is not available. Please reload the page.");
        //             return;
        //         }
        ...
        //         let sLoggedInEmployeeId = oCurrentUserModel.getProperty("/EmployeeNumber");
        ...
        //         if (!oSelectedEmpSupervisor) {
        //             MessageBox.error("Supervisor information is missing for the selected employee.");
        //             return;
        //         }
        ...
        //                     this._postDemotionRequest();
        //                 } else {
        //                     oViewModel.setProperty("/isSubmitDisabled", false); // Re-enable if cancelled
        //                 }
        //             }
        //         });
        //     }).catch((err) => {
        //         MessageBox.error("Failed to retrieve user information. Please try again.");
        //     });
        // },
        ...
        _postDemotionRequest: function () {
            ...
            const oPayload = {
                ...
                MassgDesc: this.byId("reasonTextDemotion").getText(),
                BeginDate: getFormattedDate("actDateStartDemotion"),
                EndDate: getFormattedDate("actDateEndDemotion"),
                ...
                PlansDest: this.byId("newPositionIdDemotion").getValue(),
                PlansDesc_Dest: this.byId("newPositionTextDemotion").getText(),
                PersgDest: this.byId("newEmployeeGroupIdDemotion").getValue(),
                PersgDestDesc: this.byId("newEmployeeGroupTextDemotion").getText(),
                PerskDest: this.byId("newEmployeeSubgroupIdDemotion").getValue(),
                PerskDestDesc: this.byId("newEmployeeSubgroupTextDemotion").getText(),
                WerksDest: this.byId("newPerAreaIdDemotion").getValue(),
                WerksDestDesc: this.byId("newPerAreaTextDemotion").getText(),
                BtrtlDest: this.byId("newPerSubAreaIdDemotion").getValue(),
                BtrtlDestDesc: this.byId("newPerSubAreaTextDemotion").getText(),
                Adjstmn: this.getView().getModel("dropdown").getProperty("/selectedSalaryAdj") || "",
                Zsalary: this.byId("salaryAdjValueDemotion").getValue() ? this.byId("salaryAdjValueDemotion").getValue().replace(/\D/g, '') : "0",
                Zdasar1: sSelectedAs,
                Zexholder: this.byId("employeeChangeDemotion").getValue(),
                ZexholderDesc: this.byId("employeeChangeTextDemotion").getText(),
                Zdasar2: this.byId("basicConDemotion").getValue(),
                PlansAsl: this.byId("currentPositionIdDemotion").getValue(),
                PlansDescAsl: this.byId("currentPositionTextDemotion").getText(),
                WerksAsl: this.byId("currentPerAreaIdDemotion").getValue(), 
                WerksDescAsl: this.byId("currentPerAreaTextDemotion").getText(),
                BtrtlAsl: this.byId("currentPerSubAreaIdDemotion").getValue(),
                BtrtlDescAsl: this.byId("currentPerSubAreaTextDemotion").getText(),
                OuAsl: this.byId("currentUnitOrgIdDemotion").getValue(),
                OuDecAsl: this.byId("currentUnitOrgTextDemotion").getText(),
                OuDest: this.byId("newUnitOrgIdDemotion").getValue(),
                OuDescDest: this.byId("newUnitOrgTextDemotion").getText(),
                DivisiAsl: this.byId("currentDivisionIdDemotion").getValue(),
                DivisiDescAsl: this.byId("currentDivisionTextDemotion").getText(), 
                DivisiDest: this.byId("newDivisionIdDemotion").getValue(),
                DivisiDescDest: this.byId("newDivisionTextDemotion").getText(),
                PlansReqDesc: oPlansReqDesc,
                NamaKantorReq: oNamaKantorReq,
                DivisiDescReq: oDivisiDescReq
            };
        
            console.log("Demotion Payload:", oPayload);
            ...
            // Submit Demotion data to the Demotion OData service
            const oModel = this.getOwnerComponent().getModel("Demotion");
            oModel.create("/RequestSet", oPayload, {
                success: (oData) => {
                    this._oBusyDialog.close();
                    MessageBox.success("Demotion request has been submitted successfully.", {
                        onClose: () => {
                ...
                error: (oError) => {
                    ...
                    if (oError) {
                        try {
                            ...
                            MessageBox.error("Error submitting Demotion request: " + oError.message);
                        }
                    } else {
                        MessageBox.error("Unknown error occurred while submitting Demotion request.");
                    }
                }
            });
        },
        ...
        handleCloseEmployeeChange: function(oEvent) {
            ...
            if (aContexts && aContexts.length) {
                ...
                this.byId("employeeChangeDemotion").setValue(oSelectedItem.Key);
            }
        ...
        handleCloseReason: function(oEvent) {
            ...
            if (aContexts && aContexts.length) {
                ...
                this.byId("reasonDemotion").setValue(oSelectedItem.Key);
            }
            oEvent.getSource().getBinding("items").filter([]);
        },
        ...
        handleClosePosition: function(oEvent) {
            ...
            if (aContexts && aContexts.length) {
                ...
                this.byId("newPositionIdDemotion").setValue(oSelectedItem.Key);
            }
            oEvent.getSource().getBinding("items").filter([]);
        },
        ...
        handleCloseArea: function(oEvent) {
            ...
            if (aContexts && aContexts.length) {
                ...
                this.byId("newPerAreaIdDemotion").setValue(oSelectedItem.Key);
                ...
                this.byId("newPerSubAreaIdDemotion").setValue("");
            }
            oEvent.getSource().getBinding("items").filter([]);
        },
        ...
        _loadSubAreaData: function () {
            return new Promise((resolve, reject) => {
                const oModel = this.getOwnerComponent().getModel("Demotion"); // Use the global model
        ...
        handleCloseSubArea: function (oEvent) {
            ...
            if (aContexts && aContexts.length) {
                ...
                if (oSubAreaModel) {
                    ...
                    this.byId("newPerSubAreaIdDemotion").setValue(oSelectedItem.Key2);
                } else {
                    console.error("SubArea model is not initialized.");
                }
            }
        ...
        handleCloseGroup: function (oEvent) {
            ...
            if (aContexts && aContexts.length) {
                ...
                if (oGroupModel) {
                    ...
                    this.byId("newEmployeeGroupIdDemotion").setValue(oSelectedItem.Key);
                } else {
                ...
                if (oSubGroupModel) {
                    ...
                    if (oSubGroupData) {
                        ...
                        this.byId("newEmployeeSubgroupIdDemotion").setValue(""); 
        ...
        handleCloseSubGroup: function (oEvent) {
            ...
            if (aContexts && aContexts.length) {
                ...
                if (oSubGroupModel) {
                    ...
                    this.byId("newEmployeeSubgroupIdDemotion").setValue(oSelectedItem.Key2);
                } else {
                    console.error("SubGroup model is not initialized.");
                }
            }
